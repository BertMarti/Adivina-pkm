...
| Derrota | `assets/defeat-reference.wav` | Haptic de error, solo para el jugador perdedor. |
...
2. Victoria y derrota se disparan una sola vez por transición a `finished`; existe una ventana anti-duplicado.
...
El tachado debe sonar como una confirmación rápida de interfaz, no como ruido fuerte. La selección y el destachado deben compartir el tono de confirmación elegido por el usuario. La victoria debe ser identificable, breve y no repetirse dos veces por una actualización duplicada del servidor. El audio de derrota es descendente, breve y solo se programa para el cliente que perdió.
